...
var resizePizzas = function(size) {
    ...
    //Move unchanging variables outside of loop
    //Replace querySelectorALl with getELementsbyClassName
    //Save array length in a local variable outside of loop
    var length_randomPizzaContainer = document.getElementsByClassName("randomPizzaContainer").length;
    var dx = determineDx(document.getElementsByClassName("randomPizzaContainer")[0], size);
    var newwidth = (document.getElementsByClassName("randomPizzaContainer")[0].offsetWidth + dx) + 'px';

    function changePizzaSizes(size) {
        for (var i = 0; i < length_randomPizzaContainer; i++) {
...
//Used window.screen.height to determine amounts of moving pizzas to fill screen
document.addEventListener('DOMContentLoaded', function() {
    var c = 8;
    var s = 256;
    var iheight = window.screen.height;
    var rows = Math.floor(iheight / s);
    var pizzaNumber = rows * c;
    var elem;
